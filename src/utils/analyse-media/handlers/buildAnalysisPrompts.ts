...
export function buildVenueBasicsPrompt(payload: any, workflow?: any): string {
  return [
    ...
    'If no venue information is found or if the venue name is unclear, return a JSON object with "name": "No venue found".',
    '',
    ...
    '- l: The location (city) that was searched for.',
    '- cc: The country code (e.g., "US" for United States, "FR" for France) where the venue is located.',
    '- w: The query or keywords used to find the social video this venue is based on.',
    ...
    '- If no venue name is provided or found, use "name": "No venue found".',
