...
export function buildEnrichHotelPrompt(combinedData: any): EnrichPromptResult {
  ...
  const hotelExampleOutput = `{
    ...
    "accessibilityFeatures": {
      ...
      "accessibilityDescription": "Full wheelchair accessibility with adapted bathroom facilities and roll-in showers available."
    },
    "inclusivitySignals": {
      "lgbtqWelcoming": true,
  ...
  const hotelPrompt = [
    ...
    '',
    '   **reviews object:**',
    '   - aggregate: {score: number 0-10, count: number, source: "Aggregated across Google, TripAdvisor, Booking.com"}',
    '   - scoresByCategory: {location: 0-10, cleanliness: 0-10, service: 0-10, value: 0-10}',
    ...
    '   - wheelchairAccess: Boolean - **SEARCH for wheelchair accessibility information**',
    '   - mobilityAids: Array of available mobility aids (e.g., ["Wheelchair rental", "Walking frames"])',
    '   - visualImpairmentSupport: Array of visual impairment accommodations (e.g., ["Braille signage", "Guide dog areas"])',
    '   - hearingImpairmentSupport: Array of hearing impairment accommodations (e.g., ["Hearing loops", "Sign language interpreter"])',
    '   - neurodivergentSupport: Array of neurodivergent accommodations (e.g., ["Quiet spaces", "Sensory-friendly rooms"])',
    '   - serviceAnimalPolicy: String description of service animal policy',
    '   - accessibleRoomCount: Number of accessible rooms available',
    '   - accessibilityDescription: String summary of overall accessibility features',
    '   **SEARCH for "[hotel name] accessibility features" and "[hotel name] disabled access"**',
    '',
    '   **inclusivitySignals object:**',
    '   - lgbtqWelcoming: Boolean - **SEARCH for LGBTQ+ policies or certifications**',
    '   - genderNeutralBathrooms: Boolean - look for gender-neutral facilities',
    '   - culturalAccommodations: Array of cultural/religious accommodations (e.g., ["Halal food", "Prayer rooms", "Kosher options"])',
    '   - languageSupport: Array of languages spoken by staff beyond English',
    '   - inclusivityCertifications: Array of inclusivity certifications or awards',
    '   - diversityStatement: String - hotel\'s diversity and inclusion statement if available',
    '   **SEARCH for "[hotel name] LGBTQ friendly" and "[hotel name] diversity inclusion"**',
    '',
    '   **accessInformation object:**',
    '   - entranceAccessibility: String description of entrance accessibility features',
    '   - parkingAccessibility: String description of accessible parking availability',
    '   - elevatorAccess: Boolean - presence of elevators for multi-story properties',
    '   - accessibleCommonAreas: Array of accessible common areas (e.g., ["Restaurant", "Pool", "Gym"])',
    '   - emergencyProtocols: String description of emergency procedures for accessibility needs',
    '   - assistanceAvailability: String description of staff assistance availability',
    '   **SEARCH for "[hotel name] access information" and "[hotel name] accessibility services"**',
    '',
    '   **contentLastUpdated:**',
    ...
    '',
    '6. Search Queries you might Use but not limited to:',
    ...
    '   - Ensure all scores are numbers between 0-10',
    '',
...
export function buildEnrichRoomPrompt(enrichData: any): EnrichPromptResult {
  ...
  const enrichPrompt = [
    ...
    '      "keyDifferentiators": ["Premium city view", "Larger room size", "Modern amenities"],',
    '      "bestFor": ["Business travelers wanting comfort", "Couples seeking city views"],',
    '      "notIdealFor": ["Budget-conscious travelers", "Families with young children"],',
    '      "valueProposition": "Premium room with exceptional city views and business-friendly amenities"',
    '    },',
    '    "tradeOffs": {',
    '      "advantages": ["Best city views in hotel", "Spacious layout", "Premium amenities"],',
    '      "disadvantages": ["Higher price point", "Potential street noise"],',
    '      "comparedToSimilar": [',
    '        {',
    '          "roomType": "Standard Queen Room",',
    '          "pros": ["Larger size", "Better view", "Superior amenities"],',
    ...
    '      "likelyToEnjoyIf": ["You value city views", "You prefer spacious rooms", "You travel for business"],',
    '      "mayDislikeIf": ["You\'re sensitive to street noise", "You\'re on a tight budget"],',
    '      "recommendedFor": ["Business travelers", "Anniversary trips", "City break weekends"],',
    '      "topReviewThemes": {',
    '        "positive": ["Amazing views", "Spacious room", "Comfortable bed"],',
    ...
    '        "priceDifference": 150,',
    '        "keyDifferences": ["Larger size", "Premium amenities", "Better location"],',
